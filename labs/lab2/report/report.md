...
![id, gid пользователя](image/3.jpg){#fig:002 width=70%}

4. Создаем поддиректорию dirl

![Создание поддиректории и ее местонахождение](image/4.jpg){#fig:002 width=70%}

5. Тестируем на поддиректории различные команды и изменяем права доступа. Проверяем работу команд

![Команды для нашего dirl](image/5.jpg){#fig:002 width=70%}

6. Заполняем таблицу, выполняя действия от имени владельца директорий

![Команды для нашего dirl](image/6.jpg){#fig:002 width=70%}
...
![Проверка возможности создать поддиректорию](image/6.PNG){#fig:016 width=70%}
