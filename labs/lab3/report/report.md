...
1. Создал учетную запись guest2 и задаю ему пароль (рис. [-@fig:001]).

![Guest2](image/1.jpg){#fig:001 width=70%}

2. Осуществил вход в систему от двух пользователей на двух разных консолях: guest на первой консоли и guest2 на второй консоли. (рис. [-@fig:002]).

![Вход с двух консолей](image/2.jpg){#fig:002 width=70%}

3. Для обоих пользователей командой pwd определил директорию, в которой я нахожусь. (рис. [-@fig:003]).

![Директория "гостей"](image/3.jpg){#fig:003 width=70%}

4. Уточняли имя пользователя, группу, кто входит в нее и каким группам она принажлежит. (рис. [-@fig:003]).

![Данные о пользователях guest](image/4.jpg){#fig:004 width=70%}
...
![Просмотр файла](image/6.jpg){#fig:006 width=70%}

6. Изменяли права директории от имени пользователя "гость" (рис. [-@fig:007]).

![Изменения прав](image/7.jpg){#fig:007 width=70%}

7. Изменяли права директории от имени пользователя "гость" (рис. [-@fig:007]).

![Изменения прав](image/7.jpg){#fig:007 width=70%}

![Файлы с правами и без](image/8.jpg){#fig:007 width=70%}

8. Работали с таблицей и заполняли её (рис. [-@fig:007]).

![Изменение атрибутов](image/9.jpg){#fig:007 width=70%}
